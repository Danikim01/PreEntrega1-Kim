    ...
    <AppBar position="static" className="ResponsiveNavigation">
      <Container maxWidth="xl">
        <Toolbar disableGutters className="ResponsiveNavigationContainer">
            ...
            <MenuCategories/>
            <Link style={styles.linkButton} to="/cart">
                <div
                style={{
                    display: "flex",
                    alignItems: "center",
